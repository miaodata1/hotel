...
public class Addpreorder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame1.setTitle("预订信息登记");
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                if(s.equals(preorderid)){
                    f=false;
                     JOptionPane.showMessageDialog(this,"您输入的预订订单编号已经有了，添加失败");
                     break;
                }
            }
            if(f)
            {
                    String sqlStr1="insert into preordertable (preorderid,preorderdate,yujiruzhudate,yujituifangdate,kehuid,roomid) values('"+preorderid+"','"+preorderdate+"','"+yujiruzhudate+"','"+yujituifangdate+"','"+kehuid+"','"+roomid+"')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Addpreorder().setVisible(true);
            }
        });
    }
