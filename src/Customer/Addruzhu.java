...
public class Addruzhu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame1.setTitle("住宿信息登记");
    ...
    private void addJBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJBActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                if(s.equals(ruzhuid)){
                    f=false;
                    JOptionPane.showMessageDialog(this,"您输入的入住订单编号已经有了，添加失败");
                    break;
                }
            }
            if(f)
            {
                String sqlStr1="insert into ruzhutable (ruzhuid,ruzhudate,yujituifangdate,kehuid,roomid) values('"+ruzhuid+"','"+ruzhudate+"','"+yujituifangdate+"','"+kehuid+"','"+roomid+"')";
