...
public class Kefang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        roomtai = new javax.swing.JComboBox<>();
        jLabel4 = new javax.swing.JLabel();
        adminidJTF = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        typeidJTF = new javax.swing.JTextField();
        ...
        jInternalFrame1.setTitle("客房信息设置");
        jInternalFrame1.setVisible(true);

        jLabel1.setText("房号");

        jLabel3.setText("客房状态");

        roomtai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "预订", "在住", "空闲" }));

        jLabel4.setText("管理员编号");

        jLabel5.setText("类型编号");
        ...
        jLabel6.setText("（5+顺序号）");

        jLabel7.setText("（2+顺序号）");

        jLabel8.setText("（4+顺序号）");
                                ...
                                .addGroup(jInternalFrame1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jInternalFrame1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jInternalFrame1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                                                .addGap(18, 18, 18)
                                                .addComponent(roomtai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                                                .addGap(13, 13, 13)
                                                .addComponent(adminidJTF, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                                                .addGap(13, 13, 13)
                                                .addComponent(typeidJTF, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                    .addComponent(roomidJTF, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jInternalFrame1Layout.setVerticalGroup(
            ...
            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                ...
                .addGap(27, 27, 27)
                .addGroup(jInternalFrame1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(typeidJTF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5)
                    .addComponent(jLabel8))
                .addGap(32, 32, 32)
                .addGroup(jInternalFrame1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void updateJBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateJBActionPerformed
        ...
        try{
            ...
            String typeid=this.typeidJTF.getText();
            String roomtai=this.roomtai.getSelectedItem().toString();
            ResultSet rs=statement.executeQuery("select * from kefangtable"); 
            boolean f=true;
            while(rs.next())
            {
                ...
                if(s.equals(roomid)){
                    f=false;
                    String sqlStr1="update kefangtable set roomtai='"+roomtai+"' where roomid='"+roomid+"'";
            ...
            if(f)
            {
                   JOptionPane.showMessageDialog(this,"您输入的房号不对，修改失败");
             }
            conn.close();
        }
        catch(Exception e)
    ...
    private void deleteJBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteJBActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                if(s.equals(roomid)){
                    f=false;
                    String sqlStr1="delete from kefangtable where roomid='"+roomid+"'";
                    statement.executeUpdate(sqlStr1);
            ...
            if(f)
            {
                   JOptionPane.showMessageDialog(this,"您输入的房号不对，删除失败");
             }
            conn.close();
        }
        catch(Exception e)
    ...
    private void addJBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJBActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                if(s.equals(roomid)){
                    f=false;
                     JOptionPane.showMessageDialog(this,"您输入的房号已经有了，添加失败");
                     break;
                }
            }
            if(f)
            {
                    String sqlStr1="insert into kefangtable (roomid,roomtai,typeid,adminid) values('"+roomid+"','"+roomtai+"','"+typeid+"','"+adminid+"')"; //将sql语句转换成字符串
                    statement.executeUpdate(sqlStr1);
    ...
    private javax.swing.JComboBox<String> roomtai;
    private javax.swing.JTextField typeidJTF;
