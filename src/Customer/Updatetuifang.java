...
public class Updatetuifang extends javax.swing.JFrame {

    public Updatetuifang() {
        initComponents();
    }
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                if(s.equals(tuifangid)){
                    f=false;
                    String sqlStr1="update tuifangtable set  ruzhudate='"+ruzhudate+"' where tuifangid='"+tuifangid+"'";
            ...
            if(f)
            {
                JOptionPane.showMessageDialog(this,"您输入的退房订单编号不对，修改失败");
            }
            conn.close();
        }
        catch(Exception e)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Updatetuifang().setVisible(true);
            }
        });
    }
